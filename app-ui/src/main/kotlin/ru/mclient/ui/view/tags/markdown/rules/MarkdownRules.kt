package ru.mclient.ui.view.tags.markdown.rules
...
import ru.mclient.ui.view.tags.core.base.annotation.ExperimentalParserApi
import ru.mclient.ui.view.tags.markdown.MarkdownStyles
import ru.mclient.ui.view.tags.markdown.custom.LineBreakRule
import ru.mclient.ui.view.tags.markdown.custom.OrderedListItemRule
import ru.mclient.ui.view.tags.markdown.custom.UnorderedListRule
import ru.mclient.ui.view.tags.markdown.styles.Links
...
object MarkdownRules {
    ...
    fun toList(): List<Rule> {
        return listOf(
            ...
            PATTERN_LINK.toRule(MarkdownStyles.links.link)
                .applyCustomSettings(1, onMatch = Links.onMatch),
            PATTERN_TEXT.toRule()
        )
    }
}